package uk.ac.dundee.computing.tr.instagrim.lib;
    ...
    public static void SetUpKeySpaces(Cluster c) {
        try {
            ...
            String CreateAddressType = "CREATE TYPE if not exists instagrim.address (\n"
                    ...
                    + "      zip int\n"
                    + "  );";
            String CreateCommentsList = "CREATE TABLE if not exists instagrim.comments(\n"
                    + "      commentid UUID,\n"
                    + "      picid UUID,\n"
                    + "      comment text,\n"
                    + "      user text, \n"
                    ...
                    + "  );";
            //create secondary index for comments as picid is not primary key for comparison
            String createCommentIndex = "CREATE INDEX if not exists ON instagrim.comments (picid);";
            ...
            try {
                ...
                System.out.println("Can't create Comments list " + et);
            }
            try {
